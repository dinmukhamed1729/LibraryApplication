...
import com.example.libraryapplication.databinding.ActivityPdfAddBinding;
...
public class PdfAddActivity extends AppCompatActivity {
    ...
    private Uri pdfUri;
    private final String TAG = "ADD_PDF_TAG";
    ...
    private void uploadPdfToStorage() {
        ...
        storageReference.putFile(pdfUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(PdfAddActivity.this," PDF uploading failed due to"+e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(resultCode == RESULT_OK){
            if(requestCode == PDF_PICK_CODE){
                ...
                Toast.makeText(this,  "cancelled picked pdf ",Toast.LENGTH_SHORT).show();
